Since the flask app.py looks for a container called "model-container" you need to run it with that name. Also specifying port 5000. Finally the image to load is called flaskap-container.
